...
const flagHasCaution = (flagValue) => (flagValue & iracing_socket_js_1.Flags.Caution) === iracing_socket_js_1.Flags.Caution;
const flagHasCautionWaving = (flagValue) => (flagValue & iracing_socket_js_1.Flags.CautionWaving) === iracing_socket_js_1.Flags.CautionWaving;
const EXTENSION_REQUIRED_FLAGS = iracing_socket_js_1.Flags.OneLapToGreen | iracing_socket_js_1.Flags.Caution;
const extensionRequired = (flagValue) => (flagValue & EXTENSION_REQUIRED_FLAGS) === EXTENSION_REQUIRED_FLAGS;
class CautionExtender extends events_1.EventEmitter {
    constructor({ socket }) {
        ...
        this.socket =
            socket instanceof iracing_socket_js_1.iRacingSocket ? socket : new iracing_socket_js_1.iRacingSocket(socket);
